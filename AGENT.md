...
# 2. 如需线上协作，使用 lx-nongfu / lx-txsaasdocs 走企业版腾讯文档流程
```
...
- 同事共享路径：企业版 API 能力集中到 `lx-txsaasdocs`
- 本机私有路径：个人版 `lx-txdocs` 不进入 GitHub 分享模板；如本机保留，仅供个人调试或旧流程兼容
